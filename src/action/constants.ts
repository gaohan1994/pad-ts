...
export const CHANGE_PEOPLE_MODAL_STATUS = 'CHANGE_PEOPLE_MODAL_STATUS';
export type CHANGE_PEOPLE_MODAL_STATUS = typeof CHANGE_PEOPLE_MODAL_STATUS;
...
export type CHANGE_SEARCH_STATUS = typeof CHANGE_SEARCH_STATUS;

export const CHANGE_PAY_STATUS = 'CHANGE_PAY_STATUS';
export type CHANGE_PAY_STATUS = typeof CHANGE_PAY_STATUS;
...
export const RECEIVE_SEARCH_MENU = 'RECEIVE_SEARCH_MENU';
export type RECEIVE_SEARCH_MENU = typeof RECEIVE_SEARCH_MENU;

export const RECEIVE_ALL_DISHES = 'RECEIVE_ALL_DISHES';
export type RECEIVE_ALL_DISHES = typeof RECEIVE_ALL_DISHES;
 ...
 * @param { RECEIVE_CALLED_NUMBER -- 取餐号 }
 */
export const RECEIVE_PAY_ORDER = 'RECEIVE_PAY_ORDER';
export type RECEIVE_PAY_ORDER = typeof RECEIVE_PAY_ORDER;
...
export const RECEIVE_CALLED_NUMBER = 'RECEIVE_CALLED_NUMBER';
export type RECEIVE_CALLED_NUMBER = typeof RECEIVE_CALLED_NUMBER;
